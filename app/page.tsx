...
function scientificScenePreview(scene: ScientificPrimitive[], object: CanvasObject, selected: boolean) {
  const color = strokeFor(object); const baseWidth = strokeWidthFor(object, selected); const objectDash = strokeDashFor(object); const fillFor = (fill?: "none" | "paper" | "ink" | "light") => fill === "ink" ? color : fill === "paper" ? "white" : fill === "light" ? "#e6e6e6" : "none";
