...
const annotationFieldLabels: Record<string, string> = {
  main: "Libellé", datum: "Référence", characteristic: "Caractéristique GPS", tolerance: "Tolérance", diameter: "Zone cylindrique", modifier: "Modificateur", datum1: "Référence primaire", datum2: "Référence secondaire", datum3: "Référence tertiaire", requirement: "Exigence de surface", parameter: "Paramètre", value: "Valeur", process: "Procédé", lay: "Direction des stries", allAround: "Tout autour",
  diagram: "Type de diagramme SysML", name: "Nom", function: "Fonction", constituent: "Constituant", flow: "Nature du flux", event: "Événement", guard: "Condition de garde", action: "Action", entry: "Activité d’entrée", do: "Activité continue", exit: "Activité de sortie", pseudostate: "Pseudo-état", orientation: "Orientation", forkRole: "Rôle", signal: "Signal", waveform: "Valeurs successives", chronogram: "Type de chronogramme", times: "Repères temporels",
  reqId: "Identifiant de l’exigence", statement: "Texte de l’exigence", requirementRelation: "Relation d’exigence",
  values: "Propriétés de valeur", parts: "Propriétés de partie", references: "Propriétés de référence", operations: "Opérations", structuralRelation: "Relation structurelle", symbolEnd: "Extrémité portant le symbole", startRole: "Rôle au début", startMultiplicity: "Multiplicité au début", endRole: "Rôle à la fin", endMultiplicity: "Multiplicité à la fin",
  blockType: "Type de bloc", interfaceType: "Type d’interface", portDirection: "Direction du port", itemType: "Type d’élément", flowDirection: "Sens du flux",
  sourceType: "Type de source", phase: "Phase", wavefrontType: "Type de front d’onde", direction: "Sens", apertureType: "Type d’ouverture", count: "Nombre", spacing: "Espacement", opening: "Ouverture", medium: "Milieu", pathStyle: "Type de trajet", screenName: "Nom de l’écran", pointName: "Nom du point", fringeCount: "Nombre de franges", fringeSpacing: "Interfrange", angle: "Angle", wavelength: "Longueur d’onde", distance: "Distance", mode: "Mode / fonctionnement", showAntinodes: "Afficher les ventres", profileType: "Type de profil",
  element: "Élément", hydrogens: "Nombre d’hydrogènes", charge: "Charge", isotope: "Isotope", radical: "Radical", electronVacancy: "Lacune électronique", lonePairs: "Nombre de doublets non liants", wideEnd: "Extrémité large", curvature: "Courbure", conformation: "Conformation", front1: "Substituant avant 1", front2: "Substituant avant 2", front3: "Substituant avant 3", rear1: "Substituant arrière 1", rear2: "Substituant arrière 2", rear3: "Substituant arrière 3", rotation: "Rotation de la projection", ringSize: "Taille du cycle", ringType: "Type de cycle", substituent1: "Substituant 1", substituent2: "Substituant 2", above: "Au-dessus de la flèche", below: "Sous la flèche", reagent: "Réactif", solvent: "Solvant", temperature: "Température", duration: "Durée",
  title: "Titre", transferFunction: "Fonction de transfert", omegaMin: "Pulsation minimale", omegaMax: "Pulsation maximale", gainMin: "Gain minimal", gainMax: "Gain maximal", phaseMin: "Phase minimale", phaseMax: "Phase maximale", frequencyUnit: "Unité de fréquence",
...
const annotationOptions: Partial<Record<string, string[]>> = {
  ...
  diameter: ["oui", "non"], modifier: ["aucun", "maximum de matière", "minimum de matière", "exigence d’enveloppe"], requirement: ["de base", "enlèvement", "enlèvement interdit"], allAround: ["oui", "non"],
  diagram: ["stm", "ibd", "bdd", "req", "uc", "sd"], flow: ["information", "énergie", "matière"], pseudostate: ["initial", "final"], orientation: ["horizontal", "vertical", "trigonométrique", "horaire"], forkRole: ["fourche", "jonction"], chronogram: ["binaire", "analogique"],
  requirementRelation: ["containment", "deriveReqt", "refine", "satisfy", "verify", "trace"], structuralRelation: ["association", "composition", "aggregation", "generalization"], symbolEnd: ["début", "fin"], portDirection: ["in", "out", "inout"], flowDirection: ["début vers fin", "fin vers début"],
  sourceType: ["ponctuelle", "plane", "uniforme", "fil rectiligne", "spire", "dipôle"], wavefrontType: ["circulaire", "plan"], direction: ["droite", "gauche", "sortant", "entrant", "directe", "indirecte", "moteur", "récepteur"], apertureType: ["fente simple", "trous d’Young", "réseau"], pathStyle: ["réel", "auxiliaire"], showAntinodes: ["oui", "non"], profileType: ["interférence", "diffraction"],
  radical: ["oui", "non"], electronVacancy: ["oui", "non"], wideEnd: ["début", "fin"], curvature: ["gauche", "droite"], conformation: ["décalée", "éclipsée"], ringType: ["saturé", "alterné", "aromatique"],
  channel: ["module", "phase"], traceType: ["réel", "asymptotique"], model: ["premier ordre", "deuxième ordre", "PI", "données"], marginType: ["phase", "gain"], input: ["impulsion", "échelon", "rampe"], performanceType: ["t5%", "temps de montée", "D1%", "erreur statique", "retard de traînage"], frequencyUnit: ["rad/s", "Hz"],
  diagramType: ["P-V", "P-v", "P-T", "T-s", "Amagat"], processType: ["isobare", "isochore", "isotherme", "adiabatique", "polytropique"], showCoordinates: ["oui", "non"], substance: ["corps pur", "eau", "dioxyde de carbone"], fusionSlope: ["positive", "négative"], cycleType: ["Carnot", "Stirling", "Joule-Brayton", "Rankine"], areaType: ["travail reçu", "travail fourni"], quality: ["0", "0.25", "0.5", "0.75", "1"],
  fieldType: ["magnétique", "électrique"], density: ["3", "5", "7"], representation: ["vecteurs", "lignes de champ", "symboles ⊙/⊗"], loopShape: ["circulaire", "rectangulaire"], showMoment: ["oui", "non"], trajectoryType: ["circulaire", "hélicoïdale", "parabolique", "rectiligne"], motion: ["approche", "éloignement", "immobile"], law: ["Lenz", "Faraday", "Faraday-Lenz"], dotConvention: ["oui", "non"], mode: ["moteur", "génératrice"],
};
...
export default function Home() {
  ...
  const libraryGroups = useMemo(() => {
    ...
    const permittedSections = [
      ["Tools", "Outils"],
      ["Electrical & signals", "Électricité & signaux"],
      ["Optics & waves", "Optique & ondes"],
      ["Mechanics", "Mécanique"],
      ["Standard mechanical joints", "Liaisons mécaniques normalisées"],
      ["Thermodynamics", "Thermodynamique"],
      ["Chemistry", "Chimie"],
      ["Molecular structures & mechanisms", "Structures moléculaires & mécanismes"],
      ["Lab glassware & equipment", "Verrerie & matériel de TP"],
      ["Operational amplifiers", "Amplificateurs opérationnels"],
    ] as const;
