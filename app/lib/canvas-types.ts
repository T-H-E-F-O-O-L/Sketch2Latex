...
export type ConnectionPortName = "start" | "end" | "segment" | "ground" | "inverting" | "non-inverting" | "output" | "primary-top" | "primary-bottom" | "secondary-top" | "secondary-bottom";
...
export const stampKinds: ObjectKind[] = [
  "point", "equation", "ground", "transformer", "gbf", "oscilloscope", "mass", "pulley", "pendulum", "reference-frame", "circular-trajectory", "gravity-field",
